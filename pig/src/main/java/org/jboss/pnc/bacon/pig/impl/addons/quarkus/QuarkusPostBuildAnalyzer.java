...
/**
 * @author Harsh Madhani<harshmadhani@gmail.com>
 * Date: 06-August-2020
 */
public class QuarkusPostBuildAnalyzer extends AddOn {
    ...
    public QuarkusPostBuildAnalyzer(PigConfiguration pigConfiguration, Map<String, PncBuild> builds, String releasePath, String extrasPath) {
    ...
    private static void postBuildCheck(String stagingPath, String productName) {
        ...
        try {
            ...
            FileDownloadUtils.downloadTo(new URI(stagingPathToProduct + latest_build + communityDependenciesPath), new File("new_dependencies.csv"));
            FileDownloadUtils.downloadTo(new URI(stagingPathToProduct + old_build + communityDependenciesPath), new File("old_dependencies.csv"));
            ...
            String newBuildInfo = "Community Dependencies present in new build which were not present in old build are " + CollectionUtils.subtract(newDependencies, oldDependencies);
            String oldBuildInfo = "Community Dependencies present in old build which are not present in new build are " + CollectionUtils.subtract(oldDependencies, newDependencies);
